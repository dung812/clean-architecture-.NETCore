...
namespace SocialNetwork.Api.Configurations.Versioning
{
    public static class ConfigVersioning
    {
        public static void AddCustomApiVersioning(this IServiceCollection services)
        {
            ...
            {
                option.GroupNameFormat = "'SocialNetwork_api-v'VVV"; //Format these APIVersion like 'api-v1.0.2', 'api-v2.0.1'
